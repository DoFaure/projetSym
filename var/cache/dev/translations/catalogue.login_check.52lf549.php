...
$catalogue = new MessageCatalogue('login_check', array (
));

$catalogueLogin = new MessageCatalogue('login', array (
));
$catalogue->addFallbackCatalogue($catalogueLogin);
...
$catalogueLogin->addFallbackCatalogue($catalogueEn);
