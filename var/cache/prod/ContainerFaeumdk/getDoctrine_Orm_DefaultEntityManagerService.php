...
include_once $this->targetDirs[3].'/vendor/doctrine/common/lib/Doctrine/Common/Persistence/Mapping/Driver/PHPDriver.php';
include_once $this->targetDirs[3].'/vendor/doctrine/orm/lib/Doctrine/ORM/Mapping/Driver/PHPDriver.php';
...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\PHPDriver([0 => ($this->targetDirs[3].'/src/AppBundle/Resources/config/doctrine')]), 'AppBundle\\Entity');
