...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/task/'), [0 => 'ROLE_DEV'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/project/'), [0 => 'ROLE_CHIEF'], NULL);
