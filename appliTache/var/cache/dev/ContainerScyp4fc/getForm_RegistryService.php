...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\ProjectType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ProjectType']) ? $this->services['AppBundle\Form\ProjectType'] : ($this->services['AppBundle\Form\ProjectType'] = new \AppBundle\Form\ProjectType())) && false ?: '_'};
}, 'AppBundle\\Form\\RegistrationType' => function () {
    return ${($_ = isset($this->services['app.form.registration']) ? $this->services['app.form.registration'] : ($this->services['app.form.registration'] = new \AppBundle\Form\RegistrationType())) && false ?: '_'};
}, 'AppBundle\\Form\\TaskType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\TaskType']) ? $this->services['AppBundle\Form\TaskType'] : ($this->services['AppBundle\Form\TaskType'] = new \AppBundle\Form\TaskType())) && false ?: '_'};
