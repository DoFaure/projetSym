...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'projetU', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'tacheU', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
     ...
     * {@inheritDoc}
     */
    public function addProjetU(\AppBundle\Entity\Project $projetU)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addProjetU', [$projetU]);

        return parent::addProjetU($projetU);
    }
    ...
    public function getProjetU()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProjetU', []);

        return parent::getProjetU();
    }

    /**
     * {@inheritDoc}
     */
    public function addTacheU(\AppBundle\Entity\Task $tacheU)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addTacheU', [$tacheU]);

        return parent::addTacheU($tacheU);
    }
    ...
    public function getTacheU()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTacheU', []);

        return parent::getTacheU();
    }
