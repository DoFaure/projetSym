...
class Project
{
    ...
    {
    	$this->idTacheP = new ArrayCollection();
    }
     ...
     * Add idTacheT.
     *
     * @param arrayCollection $idTacheT
     *
     * @return User
     */
    public function addIdTacheT(Task $idTacheT)
    {
        $this->idTacheT[] = $idTacheT;
     ...
     */
    public function getIdTacheT()
    {
        return $this->idTacheT;
    }
}
